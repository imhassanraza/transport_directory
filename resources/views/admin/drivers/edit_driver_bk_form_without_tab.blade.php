                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-1">
                                        <a href="{{ asset('assets/img') }}/{{ $driver->photo; }}" target="_blank">
                                            <img class="rounded-circle m-t-xs img-fluid" src="{{ asset('assets/img') }}/{{ $driver->photo; }}" style="width: 32px;">
                                        </a>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="guarantor" id="guarantor" value="{{ $driver->guarantor; }}">
                                    </div>
                                </div>
                            </div>
                        </div>
