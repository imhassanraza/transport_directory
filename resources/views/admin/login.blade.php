...
<head>
	...
	<title>{{ get_section_content('project', 'site_title') }} | Users Login</title>
	...
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			<div class="col-lg-12 text-center" style="margin-top: 150px;">
				<img class="img-responsive" src="{{ asset('assets/img') }}/{{ get_section_content('project', 'site_logo') }}" alt="logo" style="width: 240px;">
			</div>
			<h3 class="admin_login_st">Users Login</h3>
