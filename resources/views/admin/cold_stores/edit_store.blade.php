    ...
    <div class="row">
        <div class="col-lg-12">
            <form method="post" id="add_form" enctype="multipart/form-data">
                @csrf
                <input type="hidden" class="form-control" name="store_id" id="store_id" value="{{ $store->id }}">
                <div class="ibox">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control select2_demo_3" name="city" id="city">
                                            ...
                                            <option value="{{ $city->id }}" @if($city->id == $store->city_id) selected @endif>
                                                {{ $city->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="owner_name" id="owner_name" value="{{ $store->owner_name }}">
                                    </div>
                                    <label class="col-sm-1 col-form-label">Phone No</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="owner_phone" id="owner_phone" value="{{ $store->owner_phone }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Manager Name</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="manager_name" id="manager_name" value="{{ $store->manager_name }}">
                                    </div>
                                    <label class="col-sm-1 col-form-label">Phone No</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="manager_phone" id="manager_phone" value="{{ $store->manager_phone }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Address</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="address" id="address">{{ $store->address }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4 offset-2">
                                        ...
                                        <button type="button" class="ladda-button btn btn-primary btn-sm" id="btn_edit" data-style="expand-right">Save Changes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).on("click" , "#btn_edit" , function() {
        ...
        $.ajax({
            url:'{{ url('admin/cold-storage/update') }}',
            type: 'POST',
            data: formData,
            dataType:'json',
            cache: false,
